# APPLICATUON FOR SHOWING SUMMARY DATA ABOUT MEAT GIVEN SHARE GROUP
# ==================================================================
...
class GroupMainWindow(QMainWindow):
    ...
    def refreshData(self):
        ...
        # To avoid fatal errors crashing the app uses try-except-finally structure 
        try:
...
if __name__ == "__main__":
    ...
    appWindow.show() # This can also be included in the FormWithTable
    sys.exit(app.exec_())
