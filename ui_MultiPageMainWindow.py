...
# Form implementation generated from reading ui file 'c:\Users\JanneL\Documents\GitHub\hirviporukka\MultiPageMainWindow.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.summaryRefreshPushButton.setGeometry(QtCore.QRect(10, 10, 75, 23))
        self.summaryRefreshPushButton.setObjectName("summaryRefreshPushButton")
        self.meatAvgLabel = QtWidgets.QLabel(self.summaryPage)
        self.meatAvgLabel.setGeometry(QtCore.QRect(100, 10, 71, 21))
        font = QtGui.QFont()
        font.setPointSize(16)
        self.meatAvgLabel.setFont(font)
        self.meatAvgLabel.setObjectName("meatAvgLabel")
        self.meatAvgWeightedLabel = QtWidgets.QLabel(self.summaryPage)
        self.meatAvgWeightedLabel.setGeometry(QtCore.QRect(190, 10, 181, 21))
        font = QtGui.QFont()
        font.setPointSize(16)
        self.meatAvgWeightedLabel.setFont(font)
        self.meatAvgWeightedLabel.setObjectName("meatAvgWeightedLabel")
        self.licenseUsageProgressBar = QtWidgets.QProgressBar(self.summaryPage)
        self.licenseUsageProgressBar.setGeometry(QtCore.QRect(10, 60, 261, 23))
        self.licenseUsageProgressBar.setProperty("value", 24)
        self.licenseUsageProgressBar.setObjectName("licenseUsageProgressBar")
        self.label_15 = QtWidgets.QLabel(self.summaryPage)
        self.label_15.setGeometry(QtCore.QRect(10, 40, 91, 16))
        self.label_15.setObjectName("label_15")
        self.sankeyWebEngineView = QtWebEngineWidgets.QWebEngineView(self.summaryPage)
        self.sankeyWebEngineView.setGeometry(QtCore.QRect(280, 60, 611, 481))
        self.sankeyWebEngineView.setUrl(QtCore.QUrl("about:blank"))
        self.sankeyWebEngineView.setObjectName("sankeyWebEngineView")
        self.frame = QtWidgets.QFrame(self.summaryPage)
        self.frame.setGeometry(QtCore.QRect(0, 110, 271, 431))
        self.frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame.setObjectName("frame")
        self.sharedMeatLabel = QtWidgets.QLabel(self.frame)
        self.sharedMeatLabel.setGeometry(QtCore.QRect(10, 0, 105, 16))
        self.sharedMeatLabel.setObjectName("sharedMeatLabel")
        self.meatSharedTableWidget = QtWidgets.QTableWidget(self.frame)
        self.meatSharedTableWidget.setGeometry(QtCore.QRect(10, 20, 256, 192))
        ...
        self.groupSummarylabel = QtWidgets.QLabel(self.frame)
        self.groupSummarylabel.setGeometry(QtCore.QRect(10, 220, 70, 16))
        self.groupSummarylabel.setObjectName("groupSummarylabel")
        self.groupSummaryTableWidget = QtWidgets.QTableWidget(self.frame)
        self.groupSummaryTableWidget.setGeometry(QtCore.QRect(10, 240, 256, 181))
        self.groupSummaryTableWidget.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustToContents)
        ...
        self.killsKillsTableWidget.setGeometry(QtCore.QRect(10, 250, 881, 291))
        ...
        self.shotByLabel_8.setGeometry(QtCore.QRect(10, 230, 47, 13))
        ...
        self.groupBox_3.setGeometry(QtCore.QRect(10, 280, 271, 221))
        self.groupBox_3.setObjectName("groupBox_3")
        self.lineEdit = QtWidgets.QLineEdit(self.maintenancePage)
        self.lineEdit.setGeometry(QtCore.QRect(10, 20, 113, 20))
        self.lineEdit.setObjectName("lineEdit")
        self.lineEdit_2 = QtWidgets.QLineEdit(self.maintenancePage)
        self.lineEdit_2.setGeometry(QtCore.QRect(130, 20, 113, 20))
        self.lineEdit_2.setObjectName("lineEdit_2")
        self.lineEdit_3 = QtWidgets.QLineEdit(self.maintenancePage)
        self.lineEdit_3.setGeometry(QtCore.QRect(10, 60, 231, 20))
        self.lineEdit_3.setObjectName("lineEdit_3")
        self.lineEdit_4 = QtWidgets.QLineEdit(self.maintenancePage)
        self.lineEdit_4.setGeometry(QtCore.QRect(10, 100, 113, 20))
        self.lineEdit_4.setObjectName("lineEdit_4")
        self.lineEdit_5 = QtWidgets.QLineEdit(self.maintenancePage)
        self.lineEdit_5.setGeometry(QtCore.QRect(130, 100, 113, 20))
        self.lineEdit_5.setObjectName("lineEdit_5")
        self.label_7 = QtWidgets.QLabel(self.maintenancePage)
        self.label_7.setGeometry(QtCore.QRect(10, 0, 47, 13))
        self.label_7.setObjectName("label_7")
        self.label_8 = QtWidgets.QLabel(self.maintenancePage)
        self.label_8.setGeometry(QtCore.QRect(130, 0, 47, 13))
        self.label_8.setObjectName("label_8")
        self.label_9 = QtWidgets.QLabel(self.maintenancePage)
        self.label_9.setGeometry(QtCore.QRect(10, 40, 81, 16))
        self.label_9.setObjectName("label_9")
        self.label_10 = QtWidgets.QLabel(self.maintenancePage)
        self.label_10.setGeometry(QtCore.QRect(10, 80, 81, 16))
        self.label_10.setObjectName("label_10")
        self.label_11 = QtWidgets.QLabel(self.maintenancePage)
        self.label_11.setGeometry(QtCore.QRect(130, 80, 81, 16))
        self.label_11.setObjectName("label_11")
        self.pushButton = QtWidgets.QPushButton(self.maintenancePage)
        self.pushButton.setGeometry(QtCore.QRect(170, 130, 75, 23))
        self.pushButton.setObjectName("pushButton")
        self.comboBox = QtWidgets.QComboBox(self.maintenancePage)
        self.comboBox.setGeometry(QtCore.QRect(10, 190, 161, 22))
        self.comboBox.setObjectName("comboBox")
        self.label_12 = QtWidgets.QLabel(self.maintenancePage)
        self.label_12.setGeometry(QtCore.QRect(10, 170, 101, 16))
        self.label_12.setObjectName("label_12")
        self.pushButton_2 = QtWidgets.QPushButton(self.maintenancePage)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.meatAvgLabel.setText(_translate("MainWindow", "Liha KA"))
        self.meatAvgWeightedLabel.setText(_translate("MainWindow", "Liha KA painotettu"))
        self.label_15.setText(_translate("MainWindow", "Luvista käytetty"))
        ...
        self.label_7.setText(_translate("MainWindow", "Etunimi"))
        self.label_8.setText(_translate("MainWindow", "Sukunimi"))
        self.label_9.setText(_translate("MainWindow", "Jakeluosoite"))
        self.label_10.setText(_translate("MainWindow", "Postinumero"))
        self.label_11.setText(_translate("MainWindow", "Postitoimipaikka"))
        self.pushButton.setText(_translate("MainWindow", "Uusi"))
        self.label_12.setText(_translate("MainWindow", "Poistettava jäsen"))
        self.pushButton_2.setText(_translate("MainWindow", "Poista"))
