...
class GroupMainWindow(QMainWindow):
    ...
    # Agent method is for receiving signals from an UI element
    ...
    def agentRefreshData(self):
        ...
        # Read data from view jakoryhma_yhteenveto, no need to read connection arguments twice
    ...
    # because it doesn't receive signals: it's not a slot
